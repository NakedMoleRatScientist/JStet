...
task :concat do
  sh "rm game.js"
  sh "cat client/models/restart_game.js client/network/game_protocol.js client/models/title_screen.js client/models/scoreboard.js client/network/score_protocol.js client/network/net.js client/models/high_score.js client/models/title_key.js client/models/enter_score_key.js client/models/game_over.js client/models/game_over_key.js client/models/key_pressed.js client/models/score_key.js client/models/game_key.js  client/models/timer_action.js client/models/playfield.js client/models/playfield_draw.js client/models/tetromino.js client/models/j_shape.js client/models/i_shape.js client/models/l_shape.js client/models/o_shape.js client/models/z_shape.js client/models/s_shape.js client/models/t_shape.js client/models/shape_selection.js client/models/tetromino_draw.js client/modes/mode.js client/modes/engine.js > game.js"
end
